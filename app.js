  ...
  window.useTemplate = function(type) {
    const templates = {
      initial: {
        ...
        body: `Hi [Name],\n\nI came across your website at [Website] and noticed it could use a modern refresh. I'm Nico from Nico Nites, and we help businesses like yours get a professional, mobile-friendly website that actually converts visitors into customers.\n\nI'd love to build you a FREE demo site - no obligation, just a sneak peek of what your business could look like with a modern web presence.\n\nWould you be interested in seeing what we can do?\n\nBest,\nNico`
      },
      demo: {
